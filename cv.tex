...
\cvevent{Wissenschaftliche Hilfskraft}{Gesellschaft f\"ur wissenschaftliche Datenverarbeitung G\"ottingen}{2021 Oktober -- heute}{G\"ottingen}
\cvtag{High Performance Computing}
\cvtag{Forschung}
\cvtag{Storage}
\medskip
\begin{itemize}
\item Entwickeln einer Black-Box Metholoige zur Klassifizierung von I/O-Requests in linuxbasierten Systemen
\end{itemize}

\divider
\cvevent{IT-Support und Webentwickler}{Max-Planck-Institut f\"ur biophysikalische Chemie}{2017 September -- 2021 Sept.}{G\"ottingen}
\cvtag{Python}
\cvtag{Django}
\cvtag{Linux}
\cvtag{Clientsupport}
...
\cvevent{Jahrespraktikum}{Max-Planck-Institut für Dynamik und Selbstorganisation}{2015 September -- 2016 Mai}{G\"ottingen}
\cvtag{Bash}
\cvtag{Linux}
\cvtag{Python}
\begin{itemize}
\item Installation und Konfiguration verschiedenster\\Linuxdistributionen
\item Programmierungen in Bash sowie Python2
\item Grunderfahrungen Serveradministration, Webstacks, LXC
\end{itemize}
